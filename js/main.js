...
addStudent() {
    let name = prompt("Enter student full name","Meghan Cahill");
    let email = prompt("Enter student email: ","mcahill@seattleu.edu");
...
setTeacher() {
    let name = prompt("Enter full teacher name:","Andrew Asplund");
    let email = prompt("Enter teacher email:","andrewa@seattleu.edu");
...
let courseDescription = prompt("Enter the course description:", "Learning Javascript");
